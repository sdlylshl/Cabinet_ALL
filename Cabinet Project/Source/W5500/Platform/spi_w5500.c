...
void WIZ_SPI_Configuration(void)
{
...
//	
//	DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)(&(WIZ_SPI->DR));
...
//	DMA_Init(DMA2_Stream2, &DMA_InitStructure);
	...
	SPI_I2S_DMACmd(WIZ_SPI, SPI_I2S_DMAReq_Rx, ENABLE);
	SPI_I2S_DMACmd(WIZ_SPI, SPI_I2S_DMAReq_Tx, ENABLE);
...
//	while (SPI_I2S_GetFlagStatus(WIZ_SPI, SPI_I2S_FLAG_BSY) == SET)
//	{}
...
//	DMA_Cmd(DMA2_Stream2, DISABLE);
	...
	SPI_I2S_DMACmd(WIZ_SPI, SPI_I2S_DMAReq_Rx, DISABLE);
	SPI_I2S_DMACmd(WIZ_SPI, SPI_I2S_DMAReq_Tx, DISABLE);
	
	SPI_Cmd(WIZ_SPI, DISABLE);
}
